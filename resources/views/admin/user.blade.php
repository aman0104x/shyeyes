					...
					<tr data-id="{{ $user->id }}" data-phone="{{ $user->phone ?? "N/A" }}"
						...
						<td>
							@php
								...
								$imagePath = Str::startsWith($user->img, "uploads/") ? asset($user->img) : asset("uploads/users/" . $user->img);
							@endphp
	...
	<div id="editModal" class="modal">
		<div class="modal-content" style="max-width: 500px; max-height: 90vh; overflow-y: auto;">
			...
			<form id="editForm" method="POST" enctype="multipart/form-data">
				...
				<div style="margin-top: 15px;">
					<label style="display: block; margin-bottom: 5px; font-weight: 600; color: #333; font-size: 13px;">Location</label>
